...
| [0006](ADR-0006-time-owned-timed-events.md) | Time-owned timed events | Accepted | Time/scheduler | - | [0032](ADR-0032-typed-wait-registrations-and-external-wake-ownership.md) (timed wait identity only) |
...
| [0035](ADR-0035-logical-cpu-identity-and-per-cpu-scheduler-context.md) | Logical CPU identity and per-CPU scheduler context | Accepted | CPU/scheduler/preemption ownership | - | - |
