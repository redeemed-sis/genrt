...
| [0014](ADR-0014-bounded-kernel-thread-lifecycle.md) | Bounded kernel thread lifecycle | Accepted | Threads | - | [0032](ADR-0032-typed-wait-registrations-and-external-wake-ownership.md) (join waiter identity only) |
...
| [0017](ADR-0017-process-table-and-user-fault-policy.md) | Process table and user faults | Accepted | Processes | - | [0032](ADR-0032-typed-wait-registrations-and-external-wake-ownership.md) (join/wait registration identity only) |
